...
/**
*类的描述:实现TblJkzxflService(机构表)接口方法
*作者:杜长吉
*创建日期:2012-05-07
*
*修改人
...
*修改原因描述
*/
@Service(TblJkzxflService.TBLJKZXFL_SERVICE_IMPL)
@Transactional(readOnly=true)
public class TblJkzxflServiceImpl implements TblJkzxflService {

	@Resource(name=TblJkzxflDao.TBLJKZXFL_DAO_IMPL)
	private TblJkzxflDao dao;
	...
	public Pager getDataByPager(Pager p) {
		DetachedCriteria d=DetachedCriteria.forClass(TblJkzxfl.class);
	...
	public Pager getPagerByCriteria(Pager p){
		DetachedCriteria criteria = DetachedCriteria.forClass(TblJkzxfl.class);
	...
	public List<TblJkzxfl> getByName(String name) {
		// TODO Auto-generated method stub
		DetachedCriteria criteria = DetachedCriteria.forClass(TblJkzxfl.class,"R");
		if(null!=name&&!"".equals(name)){
