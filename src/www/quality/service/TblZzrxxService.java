...
*修改原因描述
*/
public interface TblZzrxxService {

	public static final String TBLZZRXX_SERVICE_IMPL = "www.pdwy.service.impl.TblZzrxxServiceImpl";
	
	/** 
	* 函 数 名 : save
	* 功能描述：该方法是对TblZzrxx在数据库表中进行添加数据
	* 参数描述  :TblZzrxx的对象 
	* 返回值  :无返回值
	* 数据库表:	TblZzrxx
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : update
	* 功能描述：该方法是对TblZzrxx在数据库表中进行修改数据
	* 参数描述  :TblZzrxx的对象 
	* 返回值  :无返回值
	* 数据库表:	TblZzrxx
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : delete
	* 功能描述：该方法是对TblZzrxx在数据库表中进行删除数据
	* 参数描述  :TblZzrxx的对象 
	* 返回值  :无返回值
	* 数据库表:	TblZzrxx
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : getAllData
	* 功能描述：该方法是对TblZzrxx在数据库表中查询所有的数据
	* 参数描述  : 无
	* 返回值  : List<TblZzrxx>
	* 数据库表:	TblZzrxx
	* 创 建 人: 杜长吉
	...
	* 功能描述：该方法是对TblZzrxx在数据库表中分页查询数据,根据需要可以添加查询条件
	* 参数描述  : 分页Pager对象
	* 返回值  : 分页对象Pager
	* 数据库表:	TblZzrxx
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : getOneById
	* 功能描述：该方法是对TblZzrxx在数据库表中根据id查询单行数据
	* 参数描述  : TblZzrxx的id
	* 返回值  : TblZzrxx对象
	* 数据库表:	TblZzrxx
	* 创 建 人: 杜长吉
	...
	* 功能描述：该方法通过条件对TblZzrxx在数据库表中的多个数据进行分页查找
	* 参数描述  : Pager 根据需要新增参数
	* 返回值  :Pager
	* 数据库表:	TblZzrxx
	* 创 建 人: 李留洋
	...
	*/
	...
	/** 
	* 函 数 名 : deleteById
	* 功能描述：该方法批量或单独删除TblZzrxx在数据库表中的数据	
