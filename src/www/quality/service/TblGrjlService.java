...
*修改原因描述
*/
public interface TblGrjlService {

	public static final String TBLGRJL_SERVICE_IMPL = "www.pdwy.service.impl.TblGrjlServiceImpl";
	
	/** 
	* 函 数 名 : save
	* 功能描述：该方法是对TblGrjl在数据库表中进行添加数据
	* 参数描述  :TblGrjl的对象 
	* 返回值  :无返回值
	* 数据库表:	TblGrjl
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : getAllData
	* 功能描述：该方法是对TblGrjl在数据库表中查询所有的数据
	* 参数描述  : 无
	* 返回值  : List<TblGrjl>
	* 数据库表:	TblGrjl
	* 创 建 人: 杜长吉
	...
	* 功能描述：该方法是对TblGrjl在数据库表中分页查询数据,根据需要可以添加查询条件
	* 参数描述  : 分页Pager对象
	* 返回值  : 分页对象Pager
	* 数据库表:	TblGrjl
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : getOneById
	* 功能描述：该方法是对TblGrjl在数据库表中根据id查询单行数据
	* 参数描述  : TblGrjl的id
	* 返回值  : TblGrjl对象
	* 数据库表:	TblGrjl
	* 创 建 人: 杜长吉
	...
	*/
	...
	/** 
	* 函 数 名 : deleteById
	* 功能描述：该方法批量或单独删除TblGrjl在数据库表中的数据	
