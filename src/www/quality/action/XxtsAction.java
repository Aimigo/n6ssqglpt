...
public class XxtsAction extends BasicAction implements ModelDriven<TblTsjl> {
	...
	public String list(){
		...
		p=tsjlser.getPagerByCriteria(p,0);
	...
	public void delete(){
		...
		logser.getLog(user.getUsername(), "共青团农场社区管理平台", "医疗卫生 >> 推送记录", "删除", "删除推送对象为“"+StringUtils.join(list,'、')+"”的数据", null);
