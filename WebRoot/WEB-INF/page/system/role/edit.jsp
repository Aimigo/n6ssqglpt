...
<script type="text/javascript">	
	$(function(){
		$("#update").click(function(){
			...
			if(oldname==name){
				form.submit();
				document.getElementById('new_jcd').style.display='none';
				document.getElementById('bgdiv').style.display='none';
				return;
			}
			
			var url = "role_isRepeat.action";
			var data = {"name":name};
			$.post(url,data,function(data){
				if(data=="1"){
					alert("角色名称重复，请重新输入角色名称！");
					form.name.focus();
					name = "";
				}else{
					form.submit();
	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;系统管理&nbsp;&gt;&gt;&nbsp;角色管理&nbsp;&gt;&gt;&nbsp;修改</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="role_update.action" method="post" name="updateform">
				...
				<div class="biaodan-all" style="height:800px;">
					...
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3"><input name="name" type="text" class="qbg" maxlength="25" value="${tblrole.name }"/></td>
						</tr>
						<tr>
							<td>描述</td>
							<td colspan="3"><input name="ms" type="text" class="qbg" maxlength="250" value="${tblrole.ms }"/></td>
						</tr>
					</table>
					<div class="bcan">
						<a href="#" id="update">
