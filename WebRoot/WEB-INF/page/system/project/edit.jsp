	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;系统管理&nbsp;&gt;&gt;&nbsp;项目管理&nbsp;&gt;&gt;&nbsp;修改</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="project_update.action" method="post" name="updateform">
				<div class="biaodan-all" style="height:800px;">
					...
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3">
								<input name="name" type="text" value="${pro.name }" class="qbg" maxlength="25"/>
								<input name="id" type="hidden" value="${pro.id }" class="qbg" maxlength="9"/>
								<input name="code" type="hidden" value="${pro.code }" class="qbg" maxlength="40"/>
								<input name="oldname" type="hidden" value="${pro.name }" class="qbg" maxlength="25"/>
							</td>
						</tr>
						<tr>
							<td>描述</td>
							<td colspan="3"><input name="ms" type="text" value="${pro.ms }" class="qbg" maxlength="250"/></td>
						</tr>
					</table>
					<div class="bcan">
						<a href="#" id="update">
