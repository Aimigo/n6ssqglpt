	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;系统管理&nbsp;&gt;&gt;&nbsp;日志管理&nbsp;&gt;&gt;&nbsp;登录日志管理&nbsp;&gt;&gt;&nbsp;详细</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<input type="hidden" name="id" value="${loginlog.id }"/>
				<div class="biaodan-all" style="height:800px;">
					<div class="biaodan-title">登录日志管理</div>
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td colspan="4" class="title2">登录日志信息</td>
						</tr>
						<tr>
							<td>用户名</td>
							<td colspan="3">
						...
						<tr>
							<td>登录时间</td>
							<td colspan="3">
								<fmt:formatDate value="${loginlog.logintime }" pattern="yyyy-MM-dd"/>
							</td>
						</tr>
						<tr>
							<td>登录IP</td>
