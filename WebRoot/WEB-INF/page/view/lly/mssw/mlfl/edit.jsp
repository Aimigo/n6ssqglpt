	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;民生事务&nbsp;&gt;&gt;&nbsp;目录分类&nbsp;&gt;&gt;&nbsp;修改</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="mlfl_update.action" method="post" name="updateform">
				<div class="biaodan-all" style="height:800px;">
					<div class="biaodan-title">目录分类信息</div>
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td colspan="4" class="title2">目录分类信息</td>
						</tr>
						<tr>
							<td>分类名称（<font class="fred">*</font>）</td>
							<td colspan="3">
								<input name="name" type="text" class="qbg" maxlength="25" value="${mlfl.name }"
									dataType="Require" msg="目录分类名称不能为空！" require="true" noRepeat="true" repeatTab="TblMlfl" repeatMsg="目录分类已经存在！" repeatId="${mlfl.id }"/>
								<input name="id" type="hidden" class="qbg" maxlength="9" value="${mlfl.id }"/>
								<input name="fid" type="hidden" class="qbg" maxlength="9" value="${mlfl.fid}"/>
							</td>
						</tr>
						<!-- <tr>
							<td>父分类</td>
