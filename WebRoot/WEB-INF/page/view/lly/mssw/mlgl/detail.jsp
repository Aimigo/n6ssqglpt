	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;民生事务&nbsp;&gt;&gt;&nbsp;目录管理&nbsp;&gt;&gt;&nbsp;详细</b>
					</div>
				</div>
				<!--当前位置  结束-->
				...
				<div class="biaodan-all">
					...
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>附件（<font class="fred">*</font>）</td>
							<td colspan="3">
								<a href="${mlgl.dz}" style="color:blue;" target="_blank">下载附件</a>
							</td>
						</tr>
						<tr>
							...
							<td>
								<fmt:formatDate value="${mlgl.scsj }" pattern="yyyy-MM-dd HH:mm:ss" />
							</td>
						</tr>
					</table>
					<div class="bcan">
