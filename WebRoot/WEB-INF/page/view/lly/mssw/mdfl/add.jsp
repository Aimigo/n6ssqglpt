	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;民生事务&nbsp;&gt;&gt;&nbsp;矛盾分类&nbsp;&gt;&gt;&nbsp;添加</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="mdfl_save.action" method="post" name="saveform">
						...
						<tr>
							...
							<td colspan="3">
								<input name="name" type="text" class="qbg" maxlength="25" 
									dataType="Require" msg="矛盾分类名称不能为空！" require="true" noRepeat="true" repeatTab="TblMdfl" repeatMsg="矛盾分类已经存在！"/>
