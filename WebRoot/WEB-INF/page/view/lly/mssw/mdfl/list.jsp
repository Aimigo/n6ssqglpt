...
<script type="text/javascript">
	function detail(id) {
		window.location.href = "mdfl_detail.action?id=" + id;
	}
	...
	function deleteIt(id) {
		if (confirm("您确定要删除吗？")) {
			$.ajax({
				type : "post",
				url : "mdfl_delete.action",
				data : {
					"id" : id
				},
				dataType : "html",
				success : function(data) {
					window.location.href = "mdfl_list.action";
				}
			});
		}
	...
	function show(id,type) {
		var url = "mdfl_add.action";
		if (id)
			url = "mdfl_edit.action?id=" + id;
		if(type)
			url = "mdfl_detail.action?id=" + id;
	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;民生事务&nbsp;&gt;&gt;&nbsp;矛盾分类</b>
					</div>
				</div>
				<!--当前位置  结束-->
				...
				<div class="tdzy-tab-down">
					<!--查询  开始-->
					<form action="mdfl_list.action" method="post">
