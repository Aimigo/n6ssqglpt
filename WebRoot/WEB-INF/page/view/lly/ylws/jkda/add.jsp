	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;医疗卫生&nbsp;&gt;&gt;&nbsp;健康档案&nbsp;&gt;&gt;&nbsp;添加</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="jkda_save.action" method="post" name="saveform">
						...
						<tr>
							...
							<td colspan="3">
								<input name="grdah" type="text" class="qbg" maxlength="14" value="${grjkda.grdah }"
									dataType="Require" msg="个人档案号不能为空！" require="true" noRepeat="true" repeatTab="TblGrjkda" repeatMsg="个人档案号已经存在！"/>
							</td>
						</tr>
						<tr>
