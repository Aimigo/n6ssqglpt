	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;医疗卫生&nbsp;&gt;&gt;&nbsp;医疗知识&nbsp;&gt;&gt;&nbsp;知识分类&nbsp;&gt;&gt;&nbsp;修改</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="ylfl_update.action" method="post" name="updateform">
				<div class="biaodan-all" style="height:800px;">
					...
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3">
								<input name="name" type="text" class="qbg" maxlength="25" value="${ylzsfl.name }"
									dataType="Require" msg="目录分类名称不能为空！" require="true" noRepeat="true" repeatTab="TblYlzsfl" repeatMsg="知识分类已经存在！" repeatId="${ylzsfl.id }"/>
								<input name="id" type="hidden" class="qbg" maxlength="9" value="${ylzsfl.id }"/>
