...
<script type="text/javascript">
	function detail(id) {
		window.location.href = "ylfl_detail.action?id=" + id;
	}
	...
	function deleteIt(id) {
		if (confirm("您确定要删除吗？")) {
			$.ajax({
				type : "post",
				url : "ylfl_delete.action",
				data : {
					"id" : id
				},
				dataType : "html",
				success : function(data) {
					window.location.href = "ylfl_list.action";
				}
			});
		}
	...
	function show(id,type) {
		var url = "ylfl_add.action";
		if (id)
			url = "ylfl_edit.action?id=" + id;
		if(type)
			url = "ylfl_detail.action?id=" + id;
	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;医疗卫生&nbsp;&gt;&gt;&nbsp;医疗知识&nbsp;&gt;&gt;&nbsp;知识分类</b>
					</div>
				</div>
				<!--当前位置  结束-->
				...
				<div class="tdzy-tab-down">
					<!--查询  开始-->
					<form action="ylfl_list.action" method="post">
