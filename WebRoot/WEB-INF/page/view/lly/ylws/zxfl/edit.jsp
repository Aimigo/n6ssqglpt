	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;医疗卫生&nbsp;&gt;&gt;&nbsp;健康咨询&nbsp;&gt;&gt;&nbsp;咨询分类&nbsp;&gt;&gt;&nbsp;修改</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="zxfl_update.action" method="post" name="updateform">
				<div class="biaodan-all" style="height:800px;">
					<div class="biaodan-title">咨询分类信息</div>
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td colspan="4" class="title2">咨询分类信息</td>
						</tr>
						<tr>
							<td>分类名称（<font class="fred">*</font>）</td>
							<td colspan="3">
								<input name="name" type="text" class="qbg" maxlength="25" value="${zxfl.name }"
									dataType="Require" msg="目录分类名称不能为空！" require="true" noRepeat="true" repeatTab="TblJkzxfl" repeatMsg="咨询分类已经存在！" repeatId="${zxfl.id }"/>
								<input name="id" type="hidden" class="qbg" maxlength="9" value="${zxfl.id }"/>
								<input name="fid" type="hidden" class="qbg" maxlength="9" value="${zxfl.fid}"/>
							</td>
						</tr>
						<!-- <tr>
							<td>父分类</td>
