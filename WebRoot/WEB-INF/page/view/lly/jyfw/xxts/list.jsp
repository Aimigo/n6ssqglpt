...
<script type="text/javascript">
	function detail(id) {
		window.location.href = "jyxxts_detail.action?id=" + id;
	}
	...
	function deleteIt(id) {
		if (confirm("您确定要删除吗？")) {
			$.ajax({
				type : "post",
				url : "jyxxts_delete.action",
				data : {
					"id" : id
				},
				dataType : "html",
				success : function(data) {
					window.location.href = "jyxxts_list.action";
				}
			});
		}
	...
	function show(id,type) {
		var url = "jyxxts_add.action";
		if (id)
			url = "jyxxts_edit.action?id=" + id;
		if(type)
			url = "jyxxts_detail.action?id=" + id;
	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;就业服务&nbsp;&gt;&gt;&nbsp;推送记录</b>
					</div>
				</div>
				<!--当前位置  结束-->
				...
				<div class="tdzy-tab-down">
					<!--查询  开始-->
					<form action="jyxxts_list.action" method="post">
