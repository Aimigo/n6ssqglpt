	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;就业服务&nbsp;&gt;&gt;&nbsp;职位信息动态&nbsp;&gt;&gt;&nbsp;修改</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="qyzp_update.action" method="post" name="updateform">
				<input name="id" type="hidden" value="${qyzp.id }"/>
				<div class="biaodan-all">
					...
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3">
								<input name="qymc" type="text" class="qbg" maxlength="50" value="${qyzp.qymc }"
						...
						<tr>
							...
							<td>
								<input name="lxr" type="text" class="qbg" maxlength="50" dataType="Require" msg="联系人不能为空！" require="true" value="${qyzp.lxr }"/>
							</td>
							<td>联系电话（<font class="fred">*</font>）</td>
							<td>
								<input name="lxdh" type="text" class="qbg" maxlength="50" dataType="Require" msg="联系电话不能为空！" require="true" value="${qyzp.lxdh }"/>
							</td>
						</tr>
						<tr>
							<td>企业地址（<font class="fred">*</font>）</td>
							<td colspan="3">
								<input name="dz" type="text" class="qbg" maxlength="100" dataType="Require" msg="企业地址不能为空！" require="true" value="${qyzp.dz }"/>
							</td>
						</tr>
						<tr>
							<td valign="top">企业描述</td>
							<td colspan="3">
								<textarea name="bz" id="bz" type="text" class="qbg" style="width:98%;">${qyzp.bz }</textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input name="zpzw" type="text" class="qbg" maxlength="50" value="${qyzp.zpzw }"
									dataType="Require" msg="招聘职位不能为空！" require="true"/>
							</td>
							<td>职位类别（<font class="fred">*</font>）</td>
							<td>
								<input name="zwlbname" type="text" class="qbg" maxlength="25" onclick="showZwfl()" readonly="readonly" value="${qyzp.zwlbname }"/>
								<input name="zwlb" type="hidden" class="qbg" maxlength="25" value="${qyzp.zwlb}"
						...
						<tr>
							...
							<td>
								<input name="zwyx" type="text" class="qbg" maxlength="25" value="${qyzp.zwyx }"
									dataType="Require" msg="职位月薪不能为空！" require="true"/>
							</td>
							<td>工作地点（<font class="fred">*</font>）</td>
							<td colspan="3">
								<input name="gzddname" type="text" class="qbg" maxlength="100" onclick="showRegion()" readonly="readonly"  value="${qyzp.gzddname }"/>
								<input name="gzdd" type="hidden" class="qbg" maxlength="100" value="${qyzp.gzdd }"
						...
						<tr>
							...
							<td>
								<input name="fbrq" type="text" class="qbg" maxlength="25"  value='<fmt:formatDate value="${qyzp.fbrq }" pattern="yyyy-MM-dd"/>'
						...
						<tr>
							...
							<td colspan="3">
								<textarea name="zwms" id="zwms" type="text" class="qbg" style="width:98%;"
									dataType="Require" msg="职位类别不能为空！" require="true">${qyzp.zwms }</textarea>
							</td>
						</tr>
						<tr>
							<td valign="top">招聘启事（<font class="fred">*</font>）</td>
							<td colspan="3">
								<input name="zpgs" id="zpgs" type="hidden" class="qbg" maxlength="50" value="${qyzp.zpgs }"
