	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;就业服务&nbsp;&gt;&gt;&nbsp;个人就业信息管理&nbsp;&gt;&gt;&nbsp;添加</b>
					</div>
				</div>
				<!--当前位置  结束-->
				
				<!--表单内容  开始-->
				<form action="grjl_save.action" method="post" name="saveform">
				<div class="biaodan-all">
					...
					<table class="biaodan" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3">
								<input name="djbbh" type="text" class="qbg" maxlength="50"
									dataType="Require" msg="登记表编号不能为空！" require="true" noRepeat="true" repeatTab="TblGrjl" repeatMsg="登记表编号已经存在！"/>
							</td>
						</tr>
						<tr>
							<td>登记日期（<font class="fred">*</font>）</td>
							<td>
								<input id="djsj" name="djsj" type="text" class="qbg" maxlength="25" 
							...
							<td>
								<input id="yxq" name="yxq" type="text" class="qbg" maxlength="25" 
						...
						<tr>
							...
							<td>
								<input name="xm" type="text" class="qbg" maxlength="25"
									dataType="Require" msg="姓名不能为空！" require="true"/>
							</td>
							<td>身份证号（<font class="fred">*</font>）</td>
							<td>
								<input name="sfzh" type="text" class="qbg" maxlength="25"
						...
						<tr>
							...
							<td>
								<input name="csrq" type="text" class="qbg" maxlength="25" 
									readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
						...
						<tr>
							...
							<td>
								<input name="mz" type="text" class="qbg" maxlength="25"
						...
						<tr>
							...
							<td>
								<input name="zp" id="zp" type="hidden" class="qbg" maxlength="50"
						...
						<tr>
							...
							<td>
								<input name="hksz" type="text" class="qbg" maxlength="50" 
						...
						<tr>
							...
							<td>
								<input name="jkzk" type="text" class="qbg" maxlength="50" 
									dataType="Require" msg="健康状况不能为空！" require="true"/>
							</td>
							<td>婚姻状况（<font class="fred">*</font>）</td>
							<td>
								<input name="hyzk" type="text" class="qbg" maxlength="50" 
						...
						<tr>
							...
							<td>
								<input name="zc" type="text" class="qbg" maxlength="25" 
									dataType="Require" msg="职称不能为空！" require="true"/>
							</td>
							<td>政治面貌（<font class="fred">*</font>）</td>
							<td>
								<input name="zzmm" type="text" class="qbg" maxlength="25" 
						...
						<tr>
							...
							<td>
								<input name="sg" type="text" class="qbg" maxlength="25" 
									dataType="Require" msg="身高不能为空！" require="true"/>
							</td>
							<td>视力（<font class="fred">*</font>）</td>
							<td>
								<input name="sl" type="text" class="qbg" maxlength="25" 
						...
						<tr>
							...
							<td>
								<input name="xxdz" type="text" class="qbg" maxlength="50" 
									dataType="Require" msg="详细地址不能为空！" require="true"/>
							</td>
							<td>联系电话（<font class="fred">*</font>）</td>
							<td>
								<input name="lldh" type="text" class="qbg" maxlength="25" 
						...
						<tr>
							...
							<td>
								<input name="lxr" type="text" class="qbg" maxlength="50" 
									dataType="Require" msg="联系人不能为空！" require="true"/>
							</td>
							<td>邮编（<font class="fred">*</font>）</td>
							<td>
								<input name="yb" type="text" class="qbg" maxlength="25" 
							...
							<td colspan="4">
								<table width="100%">
									...
									<tr>
										...
										<td>
											<input name="zygz1" type="text" class="qbg" maxlength="50" 
												dataType="Require" msg="专业工种不能为空！" require="true"/>
										</td>
										<td>
											<input name="jsdj1" type="text" class="qbg" maxlength="50" 
												dataType="Require" msg="技能等级不能为空！" require="true"/>
										</td>
										<td>
											<input name="csnx1" type="text" class="qbg" maxlength="50" 
												dataType="Require" msg="从事年限不能为空！" require="true"/>
										</td>
										<td>
											<input name="sm1" type="text" class="qbg" maxlength="100" 
									...
									<tr>
										...
										<td>
											<input name="zygz2" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="jsdj2" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="csnx2" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="sm2" type="text" class="qbg" maxlength="100"/>
										</td>
									</tr>
									<tr>
										<td align="center">3</td>
										<td>
											<input name="zygz3" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="jsdj3" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="csnx3" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="sm3" type="text" class="qbg" maxlength="100"/>
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="4">
								<table width="100%">
									...
									<tr>
										<td align="center">1</td>
										<td>
											<input name="qzywname1" type="text" class="qbg" maxlength="50" onclick="showZwfl(1)" readonly="readonly"/>
											<input name="qzyw1" type="hidden" class="qbg" maxlength="50" 
												dataType="Require" msg="请选择择业工种！" require="true"/>
										</td>
										<td>
											<input name="yxyq1" type="text" class="qbg" maxlength="50" 
												dataType="Require" msg="月薪要求不能为空！" require="true"/>
										</td>
										<td>
											<input name="jjlx1" type="text" class="qbg" maxlength="50" 
									...
									<tr>
										<td align="center">2</td>
										<td>
											<input name="qzywname2" type="text" class="qbg" maxlength="50" onclick="showZwfl(2)" readonly="readonly"/>
											<input name="qzyw2" type="hidden" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="yxyq2" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="jjlx2" type="text" class="qbg" maxlength="50"/>
										</td>
									</tr>
									<tr>
										<td align="center">3</td>
										<td>
											<input name="qzywname3" type="text" class="qbg" maxlength="50" onclick="showZwfl(3)" readonly="readonly"/>
											<input name="qzyw3" type="hidden" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="yxyq3" type="text" class="qbg" maxlength="50"/>
										</td>
										<td>
											<input name="jjlx3" type="text" class="qbg" maxlength="50"/>
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td>其他求职要求</td>
							<td colspan="3">
								<input name="qtqzyq" type="text" class="qbg" maxlength="500" />
							</td>
						</tr>
						<tr>
							<td>外语及熟练程度</td>
							<td colspan="3">
								<input name="wyslcd" type="text" class="qbg" maxlength="100" />
							</td>
						</tr>
						<tr>
							<td>其他技能</td>
							<td colspan="3">
								<input name="qtjn" type="text" class="qbg" maxlength="500" />
							</td>
						</tr>
						<tr>
							<td>择业地区（<font class="fred">*</font>）</td>
							<td colspan="3">
								<input name="zydqname" type="text" class="qbg" maxlength="500" onclick="showRegion()" readonly="readonly"/>
								<input name="zydq" type="hidden" class="qbg" maxlength="500"
						...
						<tr>
							<td>学习工作培训简历</td>
							<td colspan="3">
								<input name="xxgzpxjl" type="text" class="qbg" maxlength="1000" />
							</td>
						</tr>
						<tr>
							<td>备注</td>
							<td colspan="3">
								<input name="bz" type="text" class="qbg" maxlength="1000" />
							</td>
						</tr>
					</table>
					<div class="bcan">
