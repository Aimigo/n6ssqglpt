	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;人员管理&nbsp;&gt;&gt;&nbsp;住户管理&nbsp;&gt;&gt;&nbsp;租住人信息&nbsp;&gt;&gt;&nbsp;添加</b>
					</div>
				</div>
				<!--当前位置  结束-->

				<!--表单内容  开始-->
				<form action="zzrxx_save.action" method="post" name="saveform">
						...
						<table class="biaodan" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td width="33%">
									...
									readonly="readonly" msg="出租房屋不能为空。" id="ccfwname"
									onclick="showTree2();"
									<%--onclick="javascript:$('#popDiv').show();"--%>/>
									<input type="hidden" name="ccfwid" id="ccfwid" dataType="Require" msg="实有房屋不能为空。"/>	
								</td>
								<td width="17%">姓名（<font class="fred">*</font>）</td>
								<td width="33%"><input name="xm" type="text" class="qbg"
							...
							<tr>
								<td>身份证号</td>
								<td><input name="sfz" type="text" class="qbg" onblur="showBirthday(this);"/>
								</td>
								<td>籍贯</td>
								<td><input name="jg" type="text" class="qbg" />
								</td>
							</tr>
							<tr>
								<td>性别</td>
								<td>
								<span class="inpcheck">
								<lable for="nansheng"><input name="xb" id="nansheng" 
								type="radio" value="男" class="inputcheck" />男</lable>
								<lable for="nvsheng"><input name="xb" id="nvsheng" 
								type="radio" value="女" class="inputcheck" />女</lable></span>
								</td>
								<td>出生年月</td>
								<td><input name="csny" type="text" class="qbg" 
							...
							<tr>
								<td>文化程度</td>
								<td><input name="whcd" type="text" class="qbg" />
								</td>
								<td>政治面貌</td>
								<td><input name="zzmm" type="text" class="qbg" />
								</td>
							</tr>
							<tr>
								<td>暂住证</td>
								<td><input name="zzz" type="text" class="qbg" />
								</td>
								<td>户口所在地</td>
								<td><input name="hkszd" type="text" class="qbg" />
								</td>
							</tr>
							<tr>
								<td>自身流入地点</td>
								<td><input name="lrdd" type="text" class="qbg" />
								</td>
								<td>流入时间</td>
								<td><input name="lrsj" type="text" class="qbg" 
								readonly="readonly" onfocus="WdatePicker();"/>
								</td>
							</tr>
							<tr>
								<td>暂住时间</td>
								<td><input name="zzsj" type="text" class="qbg" 
								readonly="readonly" onfocus="WdatePicker();"/>
								</td>
								<td>婚姻状况</td>
								<td><input name="hyzk" type="text" class="qbg" />
								</td>
							</tr>
							<tr>
								<td>避孕措施</td>
								<td><input name="bycs" type="text" class="qbg" />
								</td>
								<td>避孕时间</td>
								<td><input name="bysj" type="text" class="qbg" 
								readonly="readonly" onfocus="WdatePicker();"/>
								</td>
							</tr>
							<tr>
								<td>健康状况</td>
								<td><input name="jjzk" type="text" class="qbg" />
								</td>
								<td>孕育证明</td>
								<td><input name="hyzm" type="text" class="qbg" />
								</td>
							</tr>
							<tr>
								<td>民族</td>
								<td><input name="mz" type="text" class="qbg" />
								</td>
								<td>关注度</td>
								<td><input name="gzd" type="text" class="qbg" />
								</td>
							</tr>
							<tr>
								<td>电话</td>
								<td><input name="dh" type="text" class="qbg" />
								</td>
								<td></td>
								<td>
								</td>
			...
			<tr>
				<td>
					...
					<script type="text/javascript">
						...
						d = new dTree('d');
						d.add(0, -1, '实有房屋');
						<c:forEach items="${czfw}" var="fw">
							d.add('${fw.id}',0,'${fw.syfwname}',"javascript:getid('${fw.id}','${fw.syfwname}');");
						</c:forEach>
