	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;人员管理&nbsp;&gt;&gt;&nbsp;信息通知&nbsp;&gt;&gt;&nbsp;添加</b>
					</div>
				</div>
				<!--当前位置  结束-->
				<!--表单内容  开始-->
				<form action="xxtz_save.action" method="post" name="saveform">
					<div class="biaodan-all">
						<div class="biaodan-title">信息通知</div>
						<table class="biaodan" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="2" class="title2">信息通知</td>
							</tr>
							<tr>
								<td width="17%">发送网格对象（<font class="fred">*</font>）</td>
								<td width="33%">
							...
							<tr>
								<td width="17%">发送内容（<font class="fred">*</font>）</td>
								<td width="33%">
								
								<input name="nr" type="text" class="qbg"
									dataType="LimitB" min="1" max="250" msg="内容不能为空."/><%--
