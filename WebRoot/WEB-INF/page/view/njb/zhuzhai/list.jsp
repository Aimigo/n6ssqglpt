	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;人员管理&nbsp;&gt;&gt;&nbsp;住户管理&nbsp;&gt;&gt;&nbsp;楼宇管理</b>
					</div>
				</div>
				<!--当前位置  结束-->
				...
				<div class="tdzy-tab-down">
					...
					<form action="" method="post" id="seach">
						<div class="chaxun-form">
							<b>查询:</b> <span> <label>名称</label> <input name="_page.params.name"
								...
								<c:forEach items="${_page.data }" var="model" varStatus="i">
									<tr <c:if test="${i.count%2 == 0 }">class="ancolorbg"</c:if>>
										...
										<td>
											...
											href="javascript:operator('x','${model.objectid}');">查看详情</a>&nbsp; </c:if>
											<c:if test='${fn:contains(operationlist,"修改") }'><a
											href="javascript:operator('e','${model.objectid}');">编辑</a>&nbsp; </c:if>
											<%--<c:if test='${fn:contains(operationlist,"删除") }'>--%><%-- <a
											href="javascript:operator('d','${model.objectid}');">删除</a>&nbsp; </c:if>--%>
										</td>
									</tr>
								</c:forEach>
