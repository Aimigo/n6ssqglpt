			...
			<div class="nchjbxx-mainbg box">
				...
				<div class="nchjbxx-mainbgright">
					<div class="nchjbxx-main">
						...
						<!--表单内容  开始-->
						<form action="czfwgl_update.action" method="post" name="updateform">
							...
							<tr>
								...
								<td width="33%">
									...
									readonly="readonly" msg="所属网格不能为空。" id="sswg" value="${fn:trim(model.sswg) }"
									onclick="showTree()"/>
									<input name="id" type="hidden" id="id" value="${model.id }"/>
								</td>
								<td width="17%">实有房屋（<font class="fred">*</font>）</td>
								<td width="33%">
								<input name="syfwid" type="hidden" id="syfwid" value="${model.syfwid }"/>
							...
							<tr>
								<td>出租人</td>
								<td>
								<input name="czr" id="czr" type="text" class="qbg" value="${model.czr }"/>
								</td>
								<td>单位和地址</td>
								<td><input name="dwjdz" type="text" class="qbg" value="${model.dwjdz }"/>
								</td>
							</tr>
							<tr>
								<td>房子使用性质</td>
								<td><input name="fzsyxz" type="text" class="qbg" value="${model.fzsyxz }"/>
								</td>
								<td>租房时间</td>
								<td><input name="zfsj" type="text" class="qbg" 
								onfocus="WdatePicker();"
								value="${fn:substring(model.zfsj,0,10) }"/>
								</td>
							</tr>
						</table>
								<div class="bcan">
