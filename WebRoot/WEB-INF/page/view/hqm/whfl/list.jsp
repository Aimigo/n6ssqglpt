...
<link href="fun/system/css/css.css" type="text/css" rel="stylesheet">
	<link href="fun/system/css/nchjbxx.css" type="text/css"
		...
		<script type="text/javascript">
			function detail(id) {
				window.location.href = "whfl_detail.action?id=" + id;
			}
			...
			function deleteIt(id) {
				if (confirm("您确定要删除吗？")) {
					$.ajax({
						type : "post",
						url : "whfl_delete.action",
						data : {
							"id" : id
						},
						dataType : "html",
						success : function(data) {
							window.location.href = "whfl_list.action";
						}
					});
				}
			...
			function show(id, type) {
				var url = "whfl_add.action";
				if (id)
					url = "whfl_edit.action?id=" + id;
				if (type)
					url = "whfl_detail.action?id=" + id;
			...
			$(function() {
				...
				$("#one").myChart({
					title : '比例图',
					subtitle : '关于系统中文化娱乐的数据分布情况',
					width : '448',
					type : 'pie',
					series : [ {
						name : '分类下数据量',
						data : eval("(" + mdata + ")")
					//	[[' 综艺节目',21],[' 体育世界',5],[' 相声小品',3],[' 卡通动漫',3],[' 其他',3]]
					} ]
				});
	...
	<div class="nchjbxx-mainbg box">
		...
		<div class="nchjbxx-mainbgright">
			<div class="nchjbxx-main">
				...
				<div class="sitebg">
					<div class="site">
						<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;数码文化娱乐信息系统&nbsp;&gt;&gt;&nbsp;数码文化娱乐资源&nbsp;&gt;&gt;&nbsp;文化娱乐资源分类</b>
					</div>
				</div>
				<!--当前位置  结束-->
				...
				<div class="tdzy-tab-down">
					<!--查询  开始-->
					<form action="whfl_list.action" method="post">
						<div class="chaxun-form">
							<b>查询:</b> <span> <label>分类名称</label> <input name="name"
