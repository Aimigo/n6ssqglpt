			...
			<div class="nchjbxx-mainbg box">
				...
				<div class="nchjbxx-mainbgright">
					<div class="nchjbxx-main">
						...
						<div class="sitebg">
							<div class="site">
								<b>当前位置：共青团农场社区管理平台&nbsp;&gt;&gt;&nbsp;数码文化娱乐信息系统&nbsp;&gt;&gt;&nbsp;数码文化娱乐资源&nbsp;&gt;&gt;&nbsp;文化娱乐资源分类&nbsp;&gt;&gt;&nbsp;修改</b>
							</div>
						</div>
						<!--当前位置  结束-->

						<!--表单内容  开始-->
						<form action="whfl_update.action" method="post" name="updateform">
							<div class="biaodan-all" style="height:800px;">
								...
								<table class="biaodan" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td colspan="4" class="title2">文化娱乐分类信息</td>
									</tr>
									<tr>
										<td>分类名称（<font class="fred">*</font>）</td>
										<td colspan="3"><input name="name" type="text"
											value="${whfl.name }" class="qbg" maxlength="25"
											dataType="Require" msg="文化娱乐分类名称不能为空！" repeatId="${whfl.id}"
											require="true" noRepeat="true" repeatTab="TblWhfl"
											repeatMsg="文化娱乐分类名称已经存在！" /> <input name="id" type="hidden"
											value="${whfl.id}" class="qbg" maxlength="9" />
										</td>
									</tr>
								</table>
								<div class="bcan">
									<a href="#" id="update"> <img
