...
;(function($){
	...
	$.fn.bgStretcher = function(settings){
		...
		function _resize(body_content){
			...
			//	Min image size
			if(settings.minWidth != 'auto'){
				if (winW < settings.minWidth){
					leftSpace = (winW - settings.minWidth)/2;
					contW = settings.minWidth;
				} else contW = winW;
			} else contW = winW;
			if(settings.minHeight != 'auto'){
				if (winH < settings.minHeight){
					contH = settings.minHeight;
				} else contH = winH;
			} else contH = winH;
